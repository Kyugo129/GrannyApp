...
class UserAdapter(view: View) :RecyclerView.ViewHolder(view){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserAdapter {
        ...
        return UserAdapter(inflater.inflate(R.layout.userlayout,parent,false))
    }
    ...
    override fun onBindViewHolder(holder: UserAdapter, position: Int) {
        ...
        holder.itemView.findViewById<TextView>(R.id.tvPassword).text = user.Password
        //declareing the executor
        val executor = Executors.newSingleThreadExecutor()
        val handler = Handler(Looper.getMainLooper())
        //setting up the image
        var image: Bitmap? = null
        val imageView = holder.itemView.findViewById<ImageView>(R.id.imPerson)
        executor.execute{
            ...
            try{
                ...
                Log.d("addednewuser", "Error happened... ono no..." + e.toString())
            }
        }
    }
